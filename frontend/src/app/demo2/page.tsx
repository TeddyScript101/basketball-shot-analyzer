...
const DEMO_SCORE = 99.3;
const DEMO_SHOOTING_ARM = "right";
const DEMO_FRAMES = 146;
const DEMO_PROCESSING_TIME = 10.64;
const DEMO_DATE = "June 13, 2026 at 12:04 PM";

const DEMO_METRICS: Metric[] = [
  { id: 101, metric_name: "Release Angle",         metric_value: 47.1,  metric_unit: "degrees",    ideal_min: 45,   ideal_max: 55   },
  { id: 102, metric_name: "Elbow Angle at Release", metric_value: 161.7, metric_unit: "degrees",    ideal_min: 155,  ideal_max: 175  },
  { id: 103, metric_name: "Knee Bend at Setup",     metric_value: 65.8,  metric_unit: "degrees",    ideal_min: 70,   ideal_max: 120  },
  { id: 104, metric_name: "Shoulder Alignment",     metric_value: 0.54,  metric_unit: "deviation",  ideal_min: 0,    ideal_max: 3    },
  { id: 105, metric_name: "Shot Duration",          metric_value: 0.44,  metric_unit: "seconds",    ideal_min: 0.4,  ideal_max: 0.9  },
  { id: 106, metric_name: "Jump Height Estimate",   metric_value: 0.142, metric_unit: "normalized", ideal_min: 0.02, ideal_max: 0.18 },
  { id: 107, metric_name: "Motion Smoothness",      metric_value: 91.6,  metric_unit: "score",      ideal_min: 75,   ideal_max: 100  },
];
...
const DEMO_RECOMMENDATIONS: Recommendation[] = [
  {
    id: 29,
    recommendation_text:
      "Excellent shooting mechanics! All key metrics are within ideal ranges. Focus on maintaining this form under defensive pressure and track session-over-session consistency.",
    metric_key: "overall",
    priority: 3,
  },
];
    ...
    <div className="min-h-screen bg-background text-foreground">
      <div className="max-w-4xl mx-auto px-4 py-8 space-y-6 animate-fade-in">
        ...
        <div className="bg-card border border-border rounded-xl p-6 space-y-3">
          ...
          <img
            src={`${process.env.NEXT_PUBLIC_BASE_PATH ?? ""}/demo2-pose.jpg`}
